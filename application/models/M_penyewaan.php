...
class M_penyewaan extends CI_Model {
    ...
    public function cektgl($tgl1, $tgl2, $id_kenda)
    {
        return $this->db->query("SELECT * FROM `tb_penyewaan` where (tgl_pinjam BETWEEN '$tgl1' AND '$tgl2') AND (tgl_selesai BETWEEN '$tgl1' AND '$tgl2') and id_kendaraan ='$id_kenda' and status_sewa='pending'");
    }
